...
//    private fun getUser(){
//        var url = "http://127.0.0.1/doan3/login.php?account=${intent.getStringExtra("user_name")}&pass=${intent.getStringExtra("user_pass")}"
...
//    }
    ...
    private fun getProduct() {
        ...
        prList.clear()
        val url = "http://192.168.1.5/doan3/getallproduct.php"
