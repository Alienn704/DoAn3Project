...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.btn_login).setOnClickListener(){
            var url = "http://192.168.1.5/doan3/login.php?account=${findViewById<EditText>(R.id.email).text}&pass=${findViewById<EditText>(R.id.username_input).text.toString().toMD5()}"
